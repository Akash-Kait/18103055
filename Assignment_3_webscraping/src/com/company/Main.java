...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        File csvFile = new File("tags_file.csv");
        csvFile.createNewFile();
        FileWriter csvWriter = new FileWriter("tags_file.csv");
        CSVWriter writer= new CSVWriter(csvWriter);

        String header[]= {"TAG", "TEXT"};
        writer.writeNext(header);

        File urlFile = new File("text_file.csv");
        urlFile.createNewFile();
        FileWriter urlWriter = new FileWriter("text_file.csv");
